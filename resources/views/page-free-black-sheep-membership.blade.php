  ...
  <div class=" xl:w-[80%] lg:w-[80%] sm:w-[100%] md:w-[100%]">
      ...
      bg-[#062D49]">
          ...
          text-black">
              <!-- Pricing -->
              <div
                  class="flex flex-row items-center justify-center pt-8 pb-8 rounded-t-[20px] bg-[#66C7C8] gap-3">
              ...
              gap-y-3 pt-10 h-full">
                  ...
                  <div>
                      <svg xmlns="http://www.w3.org/2000/svg" class="text-[#66C7C8] h-5 w-5" fill="none"
                          viewBox="0 0 24
