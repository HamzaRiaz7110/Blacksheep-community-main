  ...
  <div class=" xl:w-[80%] lg:w-[80%] sm:w-[100%] md:w-[100%]">
    <div class="flex flex-col sm:flex-col md:flex-row lg:flex-row xl:flex-row xl:space-x-12 md:space-x-0 sm:space-x-0 lg:space-x-4
      ...
      <card class="rounded-xl lg:w-[35%] flex flex-col
        ...
        <!-- Pricing -->
        <div
          class="flex flex-row items-center justify-center pt-8 pb-8 rounded-t-[20px] bg-[#F26F5B] gap-3">
        ...
        <div class="grid grid-cols-12 bg-white
          ...
          <div class="col-span-12 lg:mt-[54px] md:mt[0px]
            ...
            <a href="#" class="mt-6 w-full text-center inline-block font-Agrandir  text-lg text-[#000] rounded-md border bg-red border-red hover:text-red hover:bg-[#0000] hover:border-red focus:outline-none focus:ring-2 focus:bg-red mr-4 px-3 py-2">Back</a>
