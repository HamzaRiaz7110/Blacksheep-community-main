...
@section('content')
  ...
  <div class=" flex flex-row">
    <div class=" xl:w-[80%] lg:w-[80%] sm:w-[100%] md:w-[100%]">
      <div class="flex flex-col lg:flex-row sm:flex-col md:flex-col xl:flex-row xl:space-x-3 md:space-x-0 sm:space-x-0 lg:space-x-3
                bg-[#062D49]">
        <!-- card 1 -->
        <card class=" rounded-xl xl:w-[365px] sm:w-[100%] md:w-[100%] flex flex-col
          ...
          <div class="grid grid-cols-12 bg-white
            ...
            <div class="col-span-11 text-2xl flex
                                    items-center
                                     pl-2 text-black ">
              <h1>Free Black Sheep Membership</h1>
            </div>
            <!-- Line -->
        ...
        <!-- card 2 -->
        <card class=" mt-[20px] sm:mt-[20px] md:mt-[20px] lg:mt-[0px] xl:mt-[0px] rounded-xl xl:w-[365px] sm:w-[100%] md:w-[100%] flex flex-col
                    text-black">
          <!-- Pricing -->
